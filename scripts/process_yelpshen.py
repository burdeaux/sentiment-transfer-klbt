...
#new class from MonoTextData for csv file
class MonoCsvData(object):
    """for csv file
    label:column name 'label'
    """
    def __init__(self, fname, label='label', max_length=None, vocab=None):
        super(MonoTextData, self).__init__() #label
    ...
    def _read_corpus(self, fname, label, max_length, vocab):
        ...
        for idx,data in df.itertuples(index=False):
            line=data['text']
            lb=data[label]
...
if __name__ == '__main__':
    ...
    shen_dir = "/home/rtx2070s/exp/deep-latent-sequence-model/data/yelp"

    # train0 = "/home/rtx2070s/exp/deep-latent-sequence-model/data/yelp/sentiment.train.0"
    # train1 = "/home/rtx2070s/exp/deep-latent-sequence-model/data/yelp/sentiment.train.1"
    dev0 = "/home/rtx2070s/exp/deep-latent-sequence-model/data/yelp/sentiment.dev.0"
    dev1 = "d/home/rtx2070s/exp/deep-latent-sequence-model/data/yelp/sentiment.dev.1"
    # test0 = "/home/rtx2070s/exp/deep-latent-sequence-model/data/yelp/sentiment.test.0"
    # test1 = "/home/rtx2070s/exp/deep-latent-sequence-model/data/yelp/sentiment.test.1"
