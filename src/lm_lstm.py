...
class LSTM_LM(nn.Module):
  ...
  def decode(self, x, x_len, gumbel_softmax=False):
    ...
    if gumbel_softmax:
      ...
      # print("embed weight size is ",self.embed.weight.size())
...
def init_args():
  ...
  parser.add_argument('--seed', type=int, default=4522, metavar='S', help='random seed')
  ...
  #add vocab
  parser.add_argument('--src_vocab',type=str,default="",help="text vocab for source data")
  parser.add_argument('--trg_vocab',type=str,default="",help="text vocab for label data")
  #add train_file
  parser.add_argument('--train_src_file',type=str,default="",help="source data")
  parser.add_argument('--train_trg_file',type=str,default="",help="label data")
  #add dev_file
  parser.add_argument('--dev_src_file',type=str,default="",help="source data")
  parser.add_argument('--dev_trg_file',type=str,default="",help="label data")
  #load some other parameters
  parser.add_argument('--load_params',action="store_true",help="this is from params for whole model setting for consistency")
  parser.add_argument('--params',type=str,help="where to load the params")
  
  args = parser.parse_args()
  new_dic=vars(args)
  # if args.load_params:
  #   if not args.params:
  #     print('load from the config file config_for_lm')
  #   else:
  #     load_params=torch.load(args.params)
  #     params_dic=vars(load_params)
  #     new_dic=vars(args)
      
  #     #rewrite if new args
  #     for var in new_dic:
  #       if var in params_dic:
  #         params_dic[var]=new_dic[var]
  #       else:
  #         params_dic[var]=new_dic[var]
  #     # print(params_dic)
  #     # print(new_dic)
  #     args = argparse.Namespace(**params_dic)
  
  #add default config
  from config_for_lm import Config_lm
  config_lm=Config_lm()
  default_dic=vars(config_lm)
  params_dic=default_dic
  for var in new_dic:
      if var in params_dic:
        params_dic[var]=new_dic[var]
      else:
  ...
  # if args.load_params:
  #   if not args.params:
  #     print('add the file to load params')
  #   else:
  #     load_params=torch.load(args.params)
  #     print(vars(load_params))
  #     print(vars(args))
  #     args = argparse.Namespace(**vars(load_params),**vars(args))
